...
export default function NowPlaying() {
    const {data, isLoading, error} = useSWR("/api/now", fetcher);
        ...
        <div className="flex items-center flex-row mb-8 space-x-4 w-full">
            {data?.songUrl ? (
                <div
                    style={{
                        boxShadow:
                            "revert0 0 .2rem #fff, 0 0 .2rem #fff, 0 0 2rem #bc13fe, 0 0 0.8rem #bc13fe, 0 0 2.8rem #bc13fe, inset 0 0 1.3rem #bc13fe",
                    }}
                >
                    {" "}
                    <Image
                ...
                <svg className="h-7 w-7 mt-[-2px]" viewBox="0 0 168 168">
                    <path
                        fill="#1ED760"
